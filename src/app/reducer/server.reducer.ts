...
const initalState ={
  ACCOUNT:[
  {id: 1, name: ' Generator', provider: 'dayong Mon Ji', charges: '24054'},
  {id: 2, name: 'As.flight', provider: 'Daar Saat', charges: '4300'},
  {id: 3, name: 'NewBeesport', provider: 'Collins Net', charges: '650050'},
...
TOOLS:[
  ...
  {utilid:1,Database:'Graphql',applicationserver:'JBoss Enterprise Application',credentialid:'5'},
],
APPLICATIONS:[
